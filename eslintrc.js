...
module.exports = {
  root: true,
  ignorePatterns: ["/.next/**", "/.eslintrc.js", "/tailwind.config.ts"],
  extends: [
  ...
  rules: {
    ...
    "perfectionist/sort-imports": [
      "warn",
      {
        groups: ["external", "internal", "components", "ui", "css", "cypress"],
        "custom-groups": {
          value: {
        ...
        "internal-pattern": ["@/**", "@/translations", "@/translations/**", "@/navigation", "@/i18n", "@/middleware"],
      },
    ],
    ...
    "perfectionist/sort-objects": [
      "warn",
      {
        groups: ["breakpoints_default", "breakpoints_3xs", "breakpoints_2xs", "breakpoints_xs", "breakpoints_sm", "breakpoints_md", "breakpoints_lg", "breakpoints_xl", "breakpoints_2xl", "breakpoints_3xl", "breakpoints_4xl", "unknown"],
        "custom-groups": {
  ...
  overrides: [
    ...
    {
      files: ["src/app/**/not-found.tsx", "src/**/mdx-components.tsx"],
      rules: {
    ...
    {
      files: ["cypress/support/**", "src/components/**", "src/connections/**", "src/helpers/**", "src/lib/**"],
      rules: {
        "no-unused-vars": "off",
    ...
    {
      files: ["src/app/\\[locale\\]/(developer)/**"],
      rules: {
        "no-console": "off",
      },
    },
    {
      ...
      files: ["src/app/\\[locale\\]/(developer)/\\-\\-/ui/form/**"],
      rules: {
