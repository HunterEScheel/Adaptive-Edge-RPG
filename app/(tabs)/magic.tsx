...
export default function MagicScreen() {
  ...
  const [activeTab, setActiveTab] = useState<"schools" | "character">("schools");
    ...
    <ScrollView>
      <ThemedView style={{ backgroundColor: "#1a1a1a" }}>
        ...
        <View style={[cssStyle.row, { marginBottom: 16, borderBottomWidth: 1, borderBottomColor: "#333", backgroundColor: "#222" }]}>
          <Pressable
            style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "schools" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
          ...
          <Pressable
            style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "character" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
        ...
        {activeTab === "schools" ? <MagicSchoolManager /> : activeTab === "character" && <SpellManager />}
      </ThemedView>
    </ScrollView>
  );
}
