        ...
        <Table>
          ...
          <Rows
            data={equippedWeapons.map((weapon) => {
              ...
              return [
                weapon.name != "Unarmed" ? weapon.name + ": " + weapon.weaponHeft + " - " + weapon.weaponType : weapon.name,
    ...
    <ScrollView style={{ backgroundColor: "#1a1a1a" }}>
      <ThemedView style={[!isMobile && { marginTop: 100 }, { backgroundColor: "#1a1a1a" }]}>
        ...
        <View style={styles.tabContainer}>
          ...
          <Pressable
            style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "defensive" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
          ...
          <Pressable
            style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "special" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
