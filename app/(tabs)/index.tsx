  ...
  return (
    <ThemedView style={{ backgroundColor: "#1a1a1a", flex: 1 }}>
      ...
      <View style={[styles.row, { borderBottomWidth: 1, borderBottomColor: "#333", backgroundColor: "#222" }]}>
        <Pressable
          style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "skills" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
          onPress={() => setActiveTab("skills")}
        >
          <ThemedText style={[styles.subtitle, activeTab === "skills" && { color: "#2196F3" }]}>Skills</ThemedText>
        </Pressable>
        <Pressable
          style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "flaws" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
          onPress={() => setActiveTab("flaws")}
        >
          <ThemedText style={[styles.subtitle, activeTab === "flaws" && { color: "#2196F3" }]}>Flaws</ThemedText>
        </Pressable>
        <Pressable
          style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "tethers" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
