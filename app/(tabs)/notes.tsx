    ...
    <ScrollView style={{ backgroundColor: "#1a1a1a" }}>
      <ThemedView style={{ backgroundColor: "#1a1a1a" }}>
        ...
        <View style={[styles.row, { borderBottomWidth: 1, borderBottomColor: "#333", backgroundColor: "#222" }]}>
          <Pressable
            style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "general" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
          ...
          <Pressable
            style={[{ flex: 1, paddingVertical: 12, alignItems: "center" }, activeTab === "npcs" && { borderBottomWidth: 2, borderBottomColor: "#2196F3" }]}
