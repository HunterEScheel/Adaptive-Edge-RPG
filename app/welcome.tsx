      ...
      <ThemedView style={[cssStyle.container, {}]}>
        {!showImport && !showTemplates ? (
          <>
            ...
            <Pressable style={[cssStyle.primaryButton, { margin: 8 }]} onPress={() => setShowTemplates(true)}>
              <ThemedText style={cssStyle.primaryText}>Select from Template</ThemedText>
            </Pressable>

            <Pressable style={[cssStyle.primaryButton, { margin: 8 }]} onPress={() => setShowImport(true)}>
