        ...
        if (known) {
            return (
                ...
                >
                    ...
                    {base.buildPointsRemaining >= MAGIC_SCHOOL_COST && (
                        <Pressable
                        ...
                        {selectedSchool && (
                            <>
                                ...
                                <View style={{ flexDirection: "row", gap: 8 }}>
                                    <Pressable
                                        style={[cssStyle.defaultButton, cssStyle.secondaryColors, { paddingVertical: 3 }]}
                                        onPress={() => setModalVisible(false)}
                                    >
                                        <ThemedText style={{ fontSize: 12, color: "#666" }}>Cancel</ThemedText>
                                    </Pressable>
                                    <Pressable
                                        style={[cssStyle.defaultButton, { backgroundColor: selectedSchool.color, paddingVertical: 3 }]}
