            ...
            <View style={cssStyle.container}>
              ...
              {consumables.length > 0 ? (
                <View style={cssStyle.lightContainer}>
                  <TableWrapper>
                    <Table>
                      <Row data={consumableHeaders} style={{ backgroundColor: "#f1f1f1", paddingVertical: 8 }} textStyle={{ fontWeight: "bold", textAlign: "center" }} />
                      <Rows data={consumableRows} style={{ paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: "#ddd" }} textStyle={{ textAlign: "center" }} />
                    </Table>
                  </TableWrapper>
                </View>
              ) : (
