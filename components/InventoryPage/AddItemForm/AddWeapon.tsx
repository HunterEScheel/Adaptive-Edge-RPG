...
const attributeOptions = [
  { label: "Strength", value: "pow" },
  { label: "Dexterity", value: "agi" },
];
...
export function AddWeapon({ onChange }: { onChange?: (weapon: Partial<iItem>) => void }) {
  ...
  const [weapon, setWeapon] = useState<ExtendedWeapon>({
    ...
    damageBonus: 0,
    attackBonus: 0,
    attribute: "pow", // Default to strength
    weaponHeft: "Unarmed",
    weaponType: "Stab",
  });
      ...
      <View style={styles.container}>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.formRow}>
            <VersatileInput type="string" value={weapon.name || ""} onChangeText={(text) => setWeapon({ ...weapon, name: text })} style={styles.fullWidth} placeholder="Enter weapon name" />
          </View>
          <View style={styles.formRow}>
            <VersatileInput
              label="Quantity"
