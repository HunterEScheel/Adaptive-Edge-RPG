...
export const NPCTrackerMobile: React.FC = () => {
    ...
    const renderNPC = ({ item }: { item: NPC }) => {
        ...
        return (
            <ThemedView style={cssStyle.noteCard}>
                <Pressable style={[cssStyle.row, { justifyContent: "space-between" }]} onPress={() => toggleExpanded(item.id)}>
                    <View style={cssStyle.itemHeader}>
                        <ThemedText style={cssStyle.bodyText}>{item.name}</ThemedText>
                    </View>

                    <ThemedText style={cssStyle.hint}>{item.description}</ThemedText>

                    <ThemedText style={cssStyle.smallText}>{getRelationshipDescription(item.relationshipLevel)}</ThemedText>
                </Pressable>
    ...
    return (
        <ScrollView>
            <ThemedView style={cssStyle.container}>
                <ListManagerMobile
                    title="NPCs"
                    emptyStateText="No NPC notes yet"
                            ...
                            <View style={cssStyle.container}>
                                <View style={{ height: 50 }}>
                                    <Slider
                                        ...
                                        style={{ width: 300, height: 40, backgroundColor: "#444" }}
