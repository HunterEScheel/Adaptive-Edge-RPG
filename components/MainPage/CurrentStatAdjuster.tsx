...
export function CurrentStatAdjuster({ statType, compact = false }: CurrentStatAdjusterProps) {
                    ...
                    <ThemedView style={cssStyle.modalView}>
                        ...
                        <View style={cssStyle.inputContainer}>
                            ...
                            <View style={cssStyle.adjustmentRow}>
                                <Pressable style={[cssStyle.centered, cssStyle.secondaryButton]} onPress={() => handleAdjustValue(-10)}>
                                    <ThemedText style={cssStyle.smallButtonText}>-10</ThemedText>
                                </Pressable>

                                <Pressable style={[cssStyle.centered, cssStyle.secondaryButton]} onPress={() => handleAdjustValue(-5)}>
                                    <ThemedText style={cssStyle.smallButtonText}>-5</ThemedText>
                                </Pressable>

                                <Pressable style={[cssStyle.centered, cssStyle.secondaryButton]} onPress={() => handleAdjustValue(-1)}>
                                    <ThemedText style={cssStyle.smallButtonText}>-1</ThemedText>
                                </Pressable>

                                <Pressable style={[cssStyle.centered, cssStyle.primaryButton]} onPress={() => handleAdjustValue(1)}>
                                    <ThemedText style={cssStyle.smallButtonText}>+1</ThemedText>
                                </Pressable>

                                <Pressable style={[cssStyle.centered, cssStyle.primaryButton]} onPress={() => handleAdjustValue(5)}>
                                    <ThemedText style={cssStyle.smallButtonText}>+5</ThemedText>
                                </Pressable>

                                <Pressable style={[cssStyle.centered, cssStyle.primaryButton]} onPress={() => handleAdjustValue(10)}>
                                    <ThemedText style={cssStyle.smallButtonText}>+10</ThemedText>
                                </Pressable>
                            </View>
                        </View>
                        ...
                        <View style={cssStyle.modalButtons}>
                            ...
                            <Pressable style={cssStyle.primaryButton} onPress={handleSetValue}>
    ...
    if (compact) {
        return (
            <>
                <Pressable style={[cssStyle.centered, { backgroundColor: "#f0f0f0" }]} onPress={openModal} accessibilityLabel={`Adjust current ${statName}`}>
