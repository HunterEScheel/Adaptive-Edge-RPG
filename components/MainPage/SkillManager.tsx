...
export function SkillManager() {
  ...
  const checkConnectivity = useCallback(async () => {
    ...
    try {
      ...
      const endpoints = ["https://api.github.com", "https://jsonplaceholder.typicode.com/posts/1", "https://httpbin.org/get", "https://www.google.com/favicon.ico"];
      ...
      <View style={[, { backgroundColor: "#333", padding: 3 }]}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
            <TouchableOpacity
              style={[cssStyle.condensedButton, cssStyle.secondaryColors, { width: 28, height: 28, padding: 0 }, item.level <= 1 && cssStyle.disabledButton]}
            ...
            <TouchableOpacity
              style={[cssStyle.condensedButton, cssStyle.primaryColors, { width: 28, height: 28, padding: 0 }, item.level >= 10 && cssStyle.disabledButton]}
            ...
            <TouchableOpacity style={[cssStyle.condensedButton, { width: 28, height: 28, padding: 0, backgroundColor: "#dc3545" }]} onPress={() => handleDeleteSkill(item)}>
      ...
      <View style={cssStyle.skillItem}>
        <View style={cssStyle.headerRow}>
          ...
          <View style={cssStyle.levelContainer}>
            <TouchableOpacity style={[cssStyle.centered, cssStyle.secondaryButton]} onPress={() => handleLevelChange(item, false)} disabled={item.level <= 1}>
            ...
            <TouchableOpacity style={[cssStyle.centered, cssStyle.primaryButton]} onPress={() => handleLevelChange(item, true)} disabled={item.level >= 10}>
              <ThemedText style={cssStyle.smallButtonText}>+</ThemedText>
            </TouchableOpacity>
          ...
          <View style={cssStyle.modalView}>
            ...
            <View style={cssStyle.formGroup}>
              ...
              <View style={cssStyle.inputContainer}>
                <TextInput style={cssStyle.input} value={newSkillName} onChangeText={setNewSkillName} placeholder="Enter skill name" placeholderTextColor="#999" />
                ...
                <View style={cssStyle.suggestionsContainer}>
                  ...
                  <FlatList
                    ...
                    renderItem={(suggestion) => (
                      <TouchableOpacity key={suggestion.index} style={cssStyle.suggestionItem} onPress={() => selectSuggestion(suggestion.item.skill)}>
            ...
            <View style={cssStyle.modalButtons}>
              ...
              <TouchableOpacity style={[cssStyle.primaryButton]} onPress={handleAddCustomSkill} disabled={!newSkillName.trim() || base.buildPointsRemaining < 1}>
