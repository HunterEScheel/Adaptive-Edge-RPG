...
export function StatAdjuster({ statName, fieldName, icon, minValue = 0, maxValue = 999, showBy5 = false, compact = false, isAttribute = false }: StatAdjusterProps) {
  ...
  const handleIncrement = (amount: number) => {
    ...
    if (fieldName === "energy" || fieldName === "hitPoints" || fieldName === "pow" || fieldName === "agi" || fieldName === "lor" || fieldName === "ins" || fieldName === "ins") {
      ...
      } else if (["pow", "agi", "lor", "ins", "ins"].includes(fieldName)) {
