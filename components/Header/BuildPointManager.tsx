...
export function BuildPointManager({ compact = false }: BuildPointManagerProps) {
  ...
  return (
    <ThemedView style={[cssStyle.container, compact && { marginVertical: 0 }]}>
      {compact ? (
        <>
          <Pressable style={[cssStyle.compactButton, { backgroundColor: "rgba(0, 122, 255, 0.1)", borderWidth: 1, borderColor: "rgba(0, 122, 255, 0.3)" }]} onPress={openModal} accessibilityLabel="Manage build points">
            ...
            <View style={cssStyle.centeredView}>
              <ThemedView style={cssStyle.modalView}>
                ...
                <View style={[cssStyle.row, cssStyle.card, { backgroundColor: "rgba(0, 122, 255, 0.1)" }]}>
                  <Pressable style={[cssStyle.compactButton, cssStyle.dangerButton]} onPress={() => setPointsInput((parseInt(pointsInput) - 1).toString())}>
                  ...
                  <Pressable style={[cssStyle.compactButton, cssStyle.successButton]} onPress={() => setPointsInput((parseInt(pointsInput) + 1).toString())}>
