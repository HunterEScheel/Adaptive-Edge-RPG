  ...
  return (
    <ThemedView style={cssStyle.container}>
      ...
      <View style={cssStyle.row}>
        <Pressable
          style={[cssStyle.tabButton, activeTab === "attacks" && cssStyle.activeTab]}
          onPress={() => setActiveTab("attacks")}
        >
          <ThemedText style={[cssStyle.tabText, activeTab === "attacks" && cssStyle.activeTabText]}>
            Attacks ({attacks.length})
          </ThemedText>
        </Pressable>
        <Pressable
          style={[cssStyle.tabButton, activeTab === "passives" && cssStyle.activeTab]}
          onPress={() => setActiveTab("passives")}
        >
          <ThemedText style={[cssStyle.tabText, activeTab === "passives" && cssStyle.activeTabText]}>
      ...
      {activeTab === "attacks" ? (
        attacks.length > 0 ? (
          ...
          <View style={cssStyle.emptyState}>
            <ThemedText style={cssStyle.emptyStateText}>
              No attacks yet.{"\n"}Tap the + button to add your first attack!
            </ThemedText>
          </View>
        )
      ) : passives.length > 0 ? (
        ...
        <View style={cssStyle.emptyState}>
          <ThemedText style={cssStyle.emptyStateText}>
            No passive abilities yet.{"\n"}Tap the + button to add your first passive ability!
          </ThemedText>
        </View>
      )}
          ...
          <ThemedView style={cssStyle.modalView}>
            ...
            <View style={cssStyle.modalButtons}>
              <Pressable
                ...
                onPress={() => setShowAddAttackModal(false)}
              >
                <ThemedText style={cssStyle.buttonText}>Cancel</ThemedText>
              </Pressable>
              <Pressable
                style={[cssStyle.actionButton, (!newAttackName.trim() || !newAttackBPCost) && cssStyle.disabledButton]}
        ...
        <View style={cssStyle.centeredView}>
          <ThemedView style={cssStyle.modalView}>
            ...
            <View style={cssStyle.modalButtons}>
              <Pressable
                style={cssStyle.secondaryButton}
                onPress={() => setShowAddPassiveModal(false)}
              >
                <ThemedText style={cssStyle.buttonText}>Cancel</ThemedText>
              </Pressable>
              <Pressable
                style={[cssStyle.actionButton, (!newPassiveName.trim() || !newPassiveBPCost) && cssStyle.disabledButton]}
