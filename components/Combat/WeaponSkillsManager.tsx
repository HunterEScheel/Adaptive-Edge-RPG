  ...
  const renderSkillItem = ({ item }: { item: WeaponSkill }) => {
    return (
      <View style={[cssStyle.sectionContainer, cssStyle.row]}>
        ...
        <View style={[cssStyle.sectionContainer, cssStyle.row]}>
          <Pressable style={[cssStyle.condensedButton, cssStyle.secondaryColors]} onPress={() => handleLevelChange(item, false)} disabled={item.level <= 1}>
          ...
          <Pressable style={[cssStyle.condensedButton, cssStyle.primaryColors]} onPress={() => handleLevelChange(item, true)} disabled={item.level >= 10}>
